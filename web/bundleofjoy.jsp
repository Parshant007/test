<%-- 
    Document   : bundleofjoy
    Created on : Feb 14, 2019, 9:08:15 AM
    Author     : P
--%>
...
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
         ...
         <link href="bundleofjoy.css" rel="stylesheet" type="text/css">
    ...
    <body>
       ...
       <div class="sliderdiv">
              <div id="slider">
		<figure>
                    <img src="bundle of joy/1.JPG" alt="images openeye foundation">
                   <img src="bundle of joy/2.jpg" alt="2">
                        <img src="bundle of joy/3.jpg" alt="3">
          <img src="bundle of joy/4.jpg" alt="4">
            <img src="bundle of joy/5.jpg" alt="5">
                                <img src="bundle of joy/6.JPG" alt="3">
                                            <img src="bundle of joy/7.JPG" alt="5">
                                               <img src="bundle of joy/8.JPG" alt="2">
                                                 <img src="bundle of joy/13.jpg" alt="5">
                                            <img src="bundle of joy/14.jpg" alt="7">
                        <img src="bundle of joy/9.jpg" alt="3">
          <img src="bundle of joy/10.jpg" alt="4">
            <img src="bundle of joy/11.jpg" alt="5">
                                <img src="bundle of joy/12.jpg" alt="3">
                                          
                                             <img src="bundle of joy/15.jpg" alt="7">
...
<div class="donationdiv">
    <ul >
                                       <li><a href="financialsupport.jsp">Donation</a></li>
                                    <li><a href="paddonation.jsp">Donate Sanitary Pad</a></li>
                                <li><a href="bookdonat.jsp">Donate Used/New Books</a></li>
                             
                                            <li><a href="#">Membership</a></li>
                                              <li><a href="intarnship.jsp">For Internship</a></li>
                                                <li><a href="#">Bank for Child Education</a></li>
                                             
                                                  <li><a href="bundleofjoy.jsp">Bundle Of Joy</a></li>
                                                  
                            </ul>
</div>

<div class="joy"><h3>BUNDLE OF JOY</h3></div>
<div class="joydiv">
<p>   "Service which is rendered without joy helps neither the servant nor the served but all other pleasures pale into nothingness before service which is rendered in the spirit of joy".
								<b>...M.K. Gandhi</b><br>
Social work for needy has always meant great deal of pleasure everyone should inculcate in them the spirit of working for all those who are underprivileged and also who can neither raise their voice nor are they heard.
Through BUNDLE OF JOY we provide a platform for all those who are privileged and for those who are not privileged. Privileged people can achieve utmost joy by rendering their service and donation in any possible form to our foundation.
This contribution will help us to bring joy in the lives of people who are much away from the idea of BUNDLE OF JOY.
