<%-- 
    Document   : vision
    Created on : Feb 11, 2019, 1:33:54 AM
    Author     : P
--%>
...
<div class="visionheader"><h4>VISION</h4></div>
<div class="visioninfo"><p>Our Vision is to be the primary support and platform
        for every needy children, youth and women. We intend to create a society 
        represented by a global community of informed and empowered people who can
        participate with our nation in decision making leading to a world of economic
        and social justice.  </p></div>
