<%-- 
    Document   : joinasmembefr
    Created on : Mar 10, 2019, 4:31:39 AM
    Author     : P
--%>
...
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
               <link href="joinasmember.css" rel="stylesheet" type="text/css">
                        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Join as Member</title>
    </head>
    <body>
        <div class="container">
           <div class="header"> 
               <div class="logodiv"><img src="images/logo.jpg" alt="img not display" height="150" width="150"></div>
		...
		<figure>
              ...
              <img src="1img/8.jpg" alt="image not found">
                       <img src="1img/9.jpg" alt="image not found">
                            <img src="1img/2.JPG" alt="image not found">
                        
                  
                    
                        <img src="1img/3.JPG" alt="image not found">
                            <img src="1img/4.jpg" alt="images openeye foundation">
                   <img src="1img/5.jpg" alt="image not found">
                   
                         <img src="1img/7.JPG" alt="image not found">
                       
                       <img src="1img/10.jpg" alt="image not found">
                       <img src="1img/6.jpg" alt="image not found">
    
                            <img src="1img/1.JPG" alt="images openeye foundation">
		</figure>
	</div>
</div>
<br>
...
<div class="joinas"><h3>Join as Member</h3></div>
<div class="joinascont">
    <h4>JOIN OUR TEAM</h4>
<p>We are a small team with big hearts. We are always looking for valuable people who can help us in achieving our
    Goals.</p><br>
...
<tr>
       <td>Ordinary Membership</td>
       <td>Rs. 1,000 (Annually)</td>
        </tr>
</table><br>
<p><b>For call,WhatsApp:-</b> +917508408205</p>
<p><b>Or mail:-</b>openeyes712@gmail.com</p>
</div>
