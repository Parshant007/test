<%-- 
    Document   : bandchildedu
    Created on : Mar 21, 2019, 11:07:18 PM
    Author     : P
--%>
...
<html>
    <head>
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
         <link href="bandchildedu.css" rel="stylesheet" type="text/css">
        <title>Bank for Child</title>
    </head>
    <body>
           <div class="container">
           <div class="header"> 
          ...
          <div class="sliderdiv">
              <div id="slider">
		<figure>
                    <img src="images/1.jpg" alt="images openeye foundation">
...
<div class="bamkforchild"></div>
<div class="bamkforchildinfo"></div>
